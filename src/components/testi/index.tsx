  ...
  const CardTesti = () => {
    return (
      <div className="w-1/3 relative md:w-2/3 md:mx-auto">
        ...
        <div className="w-[95%] relative mx-auto h-[300px] bg-[#0E1330] border-[1px] border-slate-700 rounded-lg p-8 flex flex-col gap-y-7 sm:p-5 sm:h-fit">
          <div className="flex flex-col">
            <p className="text-xl font-medium mb-1">Muh.Fajri</p>
            <span className="text-sm text-slate-500">Frontend Developer</span>
          </div>
          <div className="">
            <p className="text-slate-100 leading-loose md:text-sm md:w-full ">
