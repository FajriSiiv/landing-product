  ...
  return (
    <div className="container mx-auto min-h-screen pb-10">
      ...
      <div className="mt-10 relative">
        <div className="rounded-lg w-full min-h-[400xp] p-10 bg-transparent border-2 border-slate-800 flex items-center relative overflow-hidden">
        ...
        <div className="flex gap-8 mt-8">
          <div className="w-2/5 min-h-[500px] relative overflow-hidden flex flex-col gap-y-5 p-10 border-[1px] border-slate-800 rounded-lg">
          ...
          <div className="w-3/5 min-h-[400px] relative overflow-hidden flex flex-col gap-y-5 p-10 pb-0 border-[1px] rounded-lg border-slate-800 justify-between">
